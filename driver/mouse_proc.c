...
static ssize_t mouse_proc_read(struct file *file, char __user *user_buf, size_t count, loff_t *pos) {
    ...
    buttons_raw = mouse->buttons_raw;
    last_wheel = mouse->last_wheel;
    left_clicks = mouse->left_clicks;
    right_clicks = mouse->right_clicks;
    ...
    len = scnprintf(buf, sizeof(buf), 
        ...
        last_wheel,
        packet[0], packet[1], packet[2], packet[3], packet[4], packet[5], packet[6], packet[7], left_clicks, right_clicks);
